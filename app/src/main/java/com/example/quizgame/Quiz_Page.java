...
public class Quiz_Page extends AppCompatActivity {
    ...
    //Verileri atacağımız String fonksiyonları
    String quizQuestion;
    String quizAnswerA;
    String quizAnswerB;
    String quizAnswerC;
    ...
    int questionCount;
    int questionNumber = 1; //Soruları çekmeye 1 den başlıyoruz
    ...
    public void game()
    {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Sırayla sorular, a, b, c, d, şıkları gösterilecek
                ...
                {
                    Toast.makeText(Quiz_Page.this,"Tebrikler! Tüm soruları cevapladınız", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(Quiz_Page.this,"Üzgünüz! Bir problem mevcut", Toast.LENGTH_LONG).show();
    ...
    public void startTimer()
    {
        countDownTimer = new CountDownTimer(timeLeft,1000) {
            ...
            public void onFinish() {
                timerContinue = false;
                pauseTimer();
                question.setText("Üzgünüz! Zaman doldu");
            }
        }.start();
        timerContinue = true;
    }
        ...
        databaseReferenceSecond.child("scores").child(userUID).child("correct").setValue(userCorrect)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Quiz_Page.this,"Puanınız başarılı bir şekilde gönderildi",Toast.LENGTH_LONG).show();
                    }
                });
        databaseReferenceSecond.child("scores").child(userUID).child("wrong").setValue(userCorrect);
    }
}